...
//                // Mapeia a entidade Produto de volta para um DTO para retornar na resposta
//                // Isso garante que o front-end receba a versão mais atualizada e completa (com ID, datas, etc.)
